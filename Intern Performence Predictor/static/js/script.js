document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- Action Form/Link Handling (AJAX + History Replacement) ---
    function setupActionForms() {
        // Handle Forms
        const forms = document.querySelectorAll('form.replace-history');
        forms.forEach(form => {
        ...
        // Handle Links
        const links = document.querySelectorAll('a.replace-history');
        links.forEach(link => {
            if (link.dataset.attached === 'true') return;
    ...
    setupActionForms();
    const observer = new MutationObserver(() => setupActionForms());
